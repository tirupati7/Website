...
class DetailedPostView extends Component {
    ...
    componentDidMount() {
        console.log('componentDidMount on DetailedPostView this.props::; ' + JSON.stringify(this.props.detailedPost));
    }
        ...
        return (
            <div className="navbar-wrapper home-wrapper detailed-post-wrapper">
                <div>
                    ...
                    <div className="detailed-post-img"><Image src={detailedPost.image} fluid width="1000px" height="555px" /></div>
                    {desc.length > 0 &&
                        desc.map((para, i) => {
                            return (
                                <div className="detailed-post-desc">{para}</div>
                            )
                        })
                    }
                </div>
